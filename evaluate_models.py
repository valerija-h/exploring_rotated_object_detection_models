...
def evaluate_baseline_model():
    ...
    baseline_model = load_baseline_checkpoint(baseline_model, "/home/rpgcps/r01vh21/Documents/models/finals/baseline_"
                                             + dataset_choice + "_epoch_5.pth")
    ...
    print(
        f"[INFO] The baseline model got {total_successes}/{len(current_dataset)} ({grasp_success_rate:.2f}%) correct "
...
if __name__ == '__main__':
    ...
    if dataset_choice == "cornell":
        ...
        sys.exit(f'[ERROR] {dataset_choice} is not a valid dataset choice.')
